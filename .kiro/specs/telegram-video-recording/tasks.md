...
- [ ] 1. Create `recording-manager.js` — recording file lifecycle
  - [ ] 1.1 Implement `RecordingManager` class with constructor and filename generation
  ...
  - [ ] 1.2 Implement listing, validation, and size checking
  ...
  - [ ]* 1.3 Write unit tests for RecordingManager (`test/recording-manager.test.js`)
  ...
  - [ ]* 1.4 Write property test: recording filename pattern (Property 1)
...
- [ ] 2. Create `telegram-bot.js` — Telegram Bot API client
  - [ ] 2.1 Implement `TelegramBot` class skeleton, `telegramRequest`, and `calculateBackoffDelay`
  ...
  - [ ] 2.2 Implement `start(token)`, `stop()`, `getStatus()`, and long-polling loop
  ...
  - [ ] 2.3 Implement message parsing and event emission
  ...
  - [ ] 2.4 Implement `sendMessage`, `sendVideo`, `sendPhoto`
  ...
  - [ ] 2.5 Implement pairing: `generatePairingToken`, `validatePairingToken`, `getPairedChatId`
  ...
  - [ ] 2.6 Implement config persistence: `saveConfig`, `loadConfig`
...
- [ ] 3. Checkpoint — RecordingManager and TelegramBot core
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Write tests for `telegram-bot.js`
  - [ ]* 4.1 Write unit tests (`test/telegram-bot.test.js`)
  ...
  - [ ]* 4.2 Write property test: message parsing (Property 2)
  ...
  - [ ]* 4.3 Write property test: exponential backoff (Property 3)
  ...
  - [ ]* 4.4 Write property test: bot status shape (Property 4)
  ...
  - [ ]* 4.5 Write property test: pairing token generation (Property 5)
  ...
  - [ ]* 4.6 Write property test: pairing token single-use (Property 6)
  ...
  - [ ]* 4.7 Write property test: pairing token expiry (Property 7)
  ...
  - [ ]* 4.8 Write property test: /run command parsing (Property 8)
  ...
  - [ ]* 4.9 Write property test: /status reply (Property 9)
  ...
  - [ ]* 4.10 Write property test: config round-trip (Property 11)
...
- [ ] 5. Checkpoint — TelegramBot tests
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. Modify `playwright-tool.js` — add recording support
  - [ ] 6.1 Add `recordingOptions` parameter to `createPlaywrightInstance`
  ...
  - [ ] 6.2 Implement recording path retrieval and graceful fallback
  ...
  - [ ]* 6.3 Write unit tests for recording support (`test/playwright-tool.test.js`)
...
- [ ] 7. Modify `direct-bridge.js` — ask_user tool, screenshot forwarding, remote jobs
  - [ ] 7.1 Add `ask_user` tool definition and `InputRequester` class
  ...
  - [ ] 7.2 Add `ask_user` execution branch in `executeTool`
  ...
  - [ ] 7.3 Add screenshot forwarding hook in agent loop
  ...
  - [ ] 7.4 Implement `RemoteJobController` class
  ...
  - [ ]* 7.5 Write property test: input request round-trip (Property 10)
  ...
  - [ ]* 7.6 Write unit tests for ask_user and RemoteJobController (`test/direct-bridge-telegram.test.js`)
...
- [ ] 8. Checkpoint — All modules implemented
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Wire everything together in `main.js`
  - [ ] 9.1 Initialize TelegramBot and RecordingManager in main process
  ...
  - [ ] 9.2 Add IPC handlers for Telegram pairing and bot control
  ...
  - [ ]* 9.3 Write integration tests (`test/telegram-bot-integration.test.js`)
